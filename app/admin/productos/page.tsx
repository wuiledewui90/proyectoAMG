...
export default function AdminProductsPage() {
  ...
  function handleSave() {
    ...
    if (isNew) {
      ...
      setProductList(productList.map((p) => (p.id === editing.id ? editing : p)))
    }
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditing({ ...editing, compatibility: e.target.value })
                  }
                  className="w-full rounded-md border border-input bg-card px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
        ...
        <div className="rounded-lg border border-border bg-card">
          <div className="overflow-x-auto">
            ...
            {productList.length === 0 && (
              <div className="p-6 text-sm text-muted-foreground">No hay productos.</div>
            )}
          </div>
        </div>
      </div>
