      ...
      <body className={`${inter.variable} font-sans antialiased`}>
        <CartProvider>
          ...
          <a
            ...
            className="fixed bottom-4 right-4 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/60 sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
