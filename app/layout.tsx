      ...
      <body className={`${inter.variable} font-sans antialiased`}>
        <CartProvider>
          ...
          <div className="fixed bottom-6 right-6 z-50 group">
            {/* Tooltip */}
            <span className="absolute bottom-full right-0 mb-2 hidden group-hover:flex items-center whitespace-nowrap rounded-lg bg-gray-900 px-3 py-1.5 text-xs font-medium text-white shadow-lg">
